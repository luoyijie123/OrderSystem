        ...
        <div class="main_container" id="dashboard_page">
            ...
            <div class="oneitem">
                <div style="width:280px;float:left;">
                    导出统计表<br>
                    <form method="post" action="${pageContext.request.contextPath}/order/downloadExcel">
                        <input type='hidden' name='csrfmiddlewaretoken' value='2yqNdiDUaUjk1bOKZGr0tvaUwDlFTOrupC1AfRMGtNAMx8pI3pkZTCWMAQEmwaXA' />
                        ...
                        <input id="txtEndDate" name="txtEndDate" style="width:170px;padding:7px 10px;border:1px solid #ccc;"
                               value="结束日期"/>
                        <br>
                        <span style="width:70px;">商品id</span>
                        <input id="productid" name="productid" style="width:170px;padding:7px 10px;border:1px solid #ccc;">
                        <Br><span style="margin-left: 30px;">商品id留空则全部导出</span>
                        <br>
                        <input type="submit" class="greenbtn" style="text-decoration:none;" value="下载对账表">
